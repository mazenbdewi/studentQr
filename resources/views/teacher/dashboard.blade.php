...
<div class="dashboard-grid">
    ...
    <div class="stat-card">
        <div class="stat-label">{{ __('teacher.my_sessions') }}</div>
        <div class="stat-value blue">{{ $sessionsCount ?? 0 }}</div>
    </div>

 
    <div class="stat-card">
        <div class="stat-label">{{ __('teacher.today_attendance') }}</div>
        <div class="stat-value green">{{ $todayAttendance ?? 0 }}</div>
    </div>

 
    <div class="stat-card">
        <div class="stat-label">{{ __('teacher.total_students') }}</div>
        <div class="stat-value indigo">{{ $totalStudents ?? 0 }}</div>
    </div>

 
    <div class="stat-card">
        <div class="stat-label">{{ __('teacher.active_session') }}</div>
        <div class="mt-4">
            @if($activeSession)
