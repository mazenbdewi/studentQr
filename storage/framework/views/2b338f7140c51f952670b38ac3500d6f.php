<?php $__env->startSection('title', __('student.confirm_attendance')); ?>
...
<div class="header">
    <div class="logo-box">
        <img src="<?php echo e(url('/images/logo.png')); ?>" alt="<?php echo e(__('student.university_name')); ?>" class="logo-image"
    ...
    <h1 class="title"><?php echo e(__('student.confirm_attendance')); ?></h1>
    <p class="subtitle"><?php echo e(__('student.university_name')); ?></p>
</div>


<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($sessionDetails) && $sessionDetails): ?>
<div class="session-info" id="sessionInfo">
    <div class="subject-name">
        <?php echo e($sessionDetails->subject?->name ?? __('student.attendance_title')); ?>

    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionDetails->lecturer): ?>
    <div class="info-row">
        <svg class="info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        </svg>
        <span><?php echo e($sessionDetails->lecturer->name); ?></span>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionDetails->hall): ?>
    <div class="info-row">
        <svg class="info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <span><?php echo e($sessionDetails->hall->name); ?></span>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionDetails->session_date): ?>
    <div class="info-row">
        <svg class="info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        </svg>
        <span><?php echo e(\Carbon\Carbon::parse($sessionDetails->session_date)->format('Y-m-d')); ?></span>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="countdown-container" id="countdownContainer">
        ...
        <span class="countdown-label"><?php echo e(__('student.time_remaining')); ?></span>
    </div>
...
<div class="messages" id="messages">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('message') && !session('success') && !session('status')): ?>
    <div class="alert alert-success">
...
<form method="POST" action="<?php echo e(route('student.attendance.store.sync', ['session' => $sessionId ?? 0])); ?>" class="form-card"
    ...
    <div class="field">
        <label for="student_number" class="label">
            ...
            <?php echo e(__('student.student_number')); ?>

        </label>

        <input id="student_number" name="student_number" type="text" value="<?php echo e(old('student_number')); ?>"
            class="input <?php echo e($errors->has('student_number') ? 'is-invalid' : ''); ?>"
            placeholder="<?php echo e(__('student.student_number')); ?>" autocomplete="off" inputmode="numeric" dir="ltr"
            aria-invalid="<?php echo e($errors->has('student_number') ? 'true' : 'false'); ?>" autofocus required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="field">
        <label for="otp" class="label">
            ...
            <?php echo e(__('student.verification_code')); ?>

        </label>

        <input id="otp" name="otp" type="text" value="<?php echo e(old('otp')); ?>"
            class="input <?php echo e($errors->has('otp') ? 'is-invalid' : ''); ?>" placeholder="******"
            autocomplete="one-time-code" inputmode="numeric" dir="ltr" maxlength="6"
            aria-invalid="<?php echo e($errors->has('otp') ? 'true' : 'false'); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <button type="submit" class="submit-btn" id="submitBtn">
        <span id="submitText"><?php echo e(__('student.verify')); ?></span>
    </button>

    <div class="footer-note">
        <?php echo e(__('student.enter_student_number_and_code')); ?>
    ...
    <div class="connection-status" id="connectionStatus">
        ...
        <span id="connectionText"><?php echo e(__('student.online')); ?></span>
    </div>

    
    <div class="loading-container" id="loadingIndicator" style="display: none;">
        <div class="spinner-large"></div>
        <div class="loading-text"><?php echo e(__('student.checking')); ?></div>
        <div class="loading-subtext" id="loadingSubtext"><?php echo e(__('student.please_wait')); ?></div>
    </div>
    ...
    <div class="status-container" id="statusContainer" style="display: none;">
        ...
        <div class="success-details" id="successDetails" style="display: none;">
            <div class="row">
                <span><?php echo e(__('student.attendance_time')); ?>:</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sessionId = <?php echo e($sessionId ?? 0); ?>;
    const qrRefreshRate = <?php echo e($sessionDetails?->qr_refresh_rate ?? 120); ?>;
    
    // Safely handle remaining seconds - ensure it's a valid positive number
    let serverRemainingSeconds = <?php echo e($remainingSeconds ?? 'null'); ?>;
    ...
    function initCountdown() {
        ...
        countdownInterval = setInterval(() => {
            ...
            if (remainingSeconds <= 0) {
                ...
                showStatus('<?php echo e(__('session.token_expired')); ?>', 'error', 'expired');
    ...
    function updateConnectionStatus(online) {
        ...
        if (connectionText) {
        connectionText.textContent = online ? '<?php echo e(__('student.online')); ?>': '<?php echo e(__('student.offline')); ?>';
        }
    }
    ...
    form.addEventListener('submit', async function(e) {
        ...
        if (!studentNumber || !otp) {
            showStatus('<?php echo e(__('student.please_fill_all_fields')); ?>', 'error');
            return;
        }

        if (otp.length !== 6) {
            showStatus('<?php echo e(__('student.invalid_otp')); ?>', 'error');
            return;
        }

        isSubmitting = true;
        submitBtn.disabled = true;
        submitText.textContent = '<?php echo e(__('student.processing')); ?>';
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route('student.attendance.store.sync', ['session' => $sessionId ?? 0])); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'Accept': 'text/html'
            ...
            submitText.textContent = '<?php echo e(__('student.verify')); ?>';
...
studentNumberInput.focus();
                ...
                if (sessionSuccess) {
                    ...
                    showStatus('<?php echo e(__('student.connection_error')); ?>', 'error');
                }
            }
    ...
    function startPolling(studentNumber) {
        ...
        pollingInterval = setInterval(async () => {
            ...
            if (pollCount > maxPolls) {
                clearInterval(pollingInterval);
                showStatus('<?php echo e(__('student.timeout_waiting')); ?>', 'error');
                return;
            }

            try {
                const response = await fetch(
                    `<?php echo e(route('student.attendance.check.status', ['session' => $sessionId ?? 0])); ?>?student_number=${encodeURIComponent(studentNumber)}`, {
                        headers: {
                ...
                if (data.success) {
                    if (data.status === 'recorded') {
                        ...
                        loadingSubtext.textContent =
                            `<?php echo e(__('student.checking')); ?> (${pollCount * 2}s)`;
                    }
                }
            } catch (error) {
    ...
    function showStatus(message, type) {
        ...
        statusTitle.textContent = type === 'success' ? '<?php echo e(__('student.success')); ?>':
            type === 'error' ? '<?php echo e(__('student.error_prefix')); ?>':
            '<?php echo e(__('student.processing')); ?>';
    ...
    function showSuccessStatus(message, attendanceTimeIso) {
        ...
        statusIcon.innerHTML = iconSvg;
        statusTitle.textContent = '<?php echo e(__('student.success')); ?>';
        statusMessageText.textContent = message;
...
<?php echo $__env->make('student.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mazen/Documents/programes/StudentAttendenceSystem/resources/views/student/attendance.blade.php ENDPATH**/ ?>