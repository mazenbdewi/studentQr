            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email"
                        class="input <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" placeholder="example@uni.edu">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input id="password" type="password" name="password" required autocomplete="current-password"
                        class="input <?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>" placeholder="********">
                    ...
                    <div class="roles-grid">
                        <label class="role-option">
                            <input type="radio" name="role" value="manager"
                                <?php echo e(old('role') === 'manager' ? 'checked' : ''); ?>>
                            <span><?php echo e(__('auth.manager')); ?></span>
                        </label>

                        <label class="role-option">
                            <input type="radio" name="role" value="lecturer"
                                <?php echo e(old('role') === 'lecturer' ? 'checked' : ''); ?>>
                            <span><?php echo e(__('auth.lecturer')); ?></span>
                        </label>

                        <label class="role-option">
                            <input type="radio" name="role" value="super-admin"
                                <?php echo e(old('role') === 'super-admin' ? 'checked' : ''); ?>>
                            <span><?php echo e(__('auth.super-admin')); ?></span>
                        </label>
                    </div>
...
</html><?php /**PATH /home/mazen/Documents/programes/StudentAttendenceSystem/resources/views/auth/custom-login.blade.php ENDPATH**/ ?>