...
return [
    'navigation' => [
        ...
        'current_academic_term' => 'Set Current Academic Term',
        'account_preparation' => 'User Account Preparation',
        'initial_setup_step_one' => 'Step One: Import Data',
        'initial_setup_step_two' => 'Step Two: Import Weekly Schedule',
        'initial_setup_step_three' => 'Step Three: Set Current Academic Term',
        'initial_setup_step_four' => 'Step Four: Prepare User Accounts',
    ...
    'import_help' => [
        ...
        'subjects' => [
            ...
            'required_columns_title' => 'Required Columns',
            'required_columns' => 'College, Department, Subject Code (unique), Subject Name, Subject Type, Sections',
            'warning_notes' => 'Subject type is required and accepts theoretical/practical or نظري/عملي. Section codes must match the type: T for theory subjects and P for practical subjects. Lecturer, academic year, and status are optional.',
        ...
        'lecture_sessions' => [
            ...
            'required_columns' => 'Subject Name, Section Code, Hall Name, Session Date (2026-04-28), Start Time (08:30), End Time (10:00)',
