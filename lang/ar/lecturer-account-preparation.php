...
return [
    ...
    'report_actions' => [
        'login_identifier_already_exists' => 'راجع التعارض مع اسم دخول أو بريد إلكتروني أو رقم جامعي موجود.',
        'missing_linked_user' => 'اربط المدرس بحساب صالح أو أنشئ حسابًا جديدًا.',
        'unexpected_item_failure' => 'راجع سجل العملية ثم أعد المحاولة للحالات المتأثرة فقط.',
        'blocked' => 'راجع حالة المدرس والحساب المرتبط قبل إعادة التشغيل.',
        'default' => 'راجع الحالة ثم أعد تشغيل الإجراء للحالات الجاهزة فقط.',
    ],
    'validation' => [
